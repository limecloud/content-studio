...
const REQUIRED_EXPORTS = [
  ...
  {
    packageName: '@limecloud/agent-capability-catalog',
    exports: ['buildAgentCapabilityPolicy', 'resolveAgentCapabilityIds'],
  },
  {
    packageName: '@limecloud/agent-workbench-adapter',
    exports: [
...
if (failures.length > 0) {
  console.error([
    ...
    '请先将 /Users/coso/Documents/dev/ai/aiclientproxy/lime/packages 中的 @limecloud/agent-* 标准 surface 发布到 npmjs，并更新 package.json / package-lock.json。',
  ].join('\n'));
  process.exit(1);
}
