...
const api: ContentStudioApi = {
  ...
  listBrandCommandCenters: (workspacePath: string) => ipcRenderer.invoke('brandCommandCenters:list', workspacePath),
  buildBrandCommandCenter: (input: BuildBrandCommandCenterInput) => ipcRenderer.invoke('brandCommandCenters:build', input),
  recordBrandCommandAction: (input: RecordBrandCommandActionInput) => ipcRenderer.invoke('brandCommandCenters:recordAction', input),
  recordBrandCommandReview: (input: RecordBrandCommandReviewInput) => ipcRenderer.invoke('brandCommandCenters:recordReview', input),
  confirmBrandCommandStage: (input: ConfirmBrandCommandStageInput) => ipcRenderer.invoke('brandCommandCenters:confirmStage', input),
  exportBrandCommandActionRecords: (input: ExportBrandCommandActionRecordsInput) => ipcRenderer.invoke('brandCommandCenters:exportActions', input),
  refreshBrandCommandActions: (input: RefreshBrandCommandActionsInput) => ipcRenderer.invoke('brandCommandCenters:refreshActions', input),
