...
export function DetailDialog({ eyebrow = 'Detail', title, description, children, onClose }: DetailDialogProps) {
  useEffect(() => {
  ...
  return (
    <div className="detail-dialog-backdrop" role="presentation" onClick={onClose}>
      <section className="detail-dialog-card" role="dialog" aria-modal="true" aria-labelledby="detail-dialog-title" onClick={(event) => event.stopPropagation()}>
