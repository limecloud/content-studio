  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-bottom">
        <div className="account-card" role="button" tabIndex={0} onClick={onOpenSettings} onKeyDown={(event) => {
          if (event.key === 'Enter' || event.key === ' ') onOpenSettings();
        }}>
          <div className="avatar">C</div>
          <span className="email">coso@gmail.com</span>
          <button className="settings-btn" type="button" aria-label="设置" title="设置">
