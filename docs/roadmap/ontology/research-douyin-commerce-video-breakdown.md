...
| 人群 | 痛点 | 卖点 | 场景 | Hook | 证据 | 视觉动作 | CTA | 状态 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 新手用户 | 怕买错 | 型号选择清晰 | 下单前 | 避坑型 | 商品详情页规格 | 型号对比字幕 | 点商品卡看版本 | ready |
| 预算敏感 | 怕贵 | 组合装均价低 | 大促 | 价格反差 | 当前活动价截图 | 价格计算板 | 先领券 | needs-review |
| 敏感肌 | 怕刺激 | 温和清洁 | 晚间护肤 | 体验型 | 用户原声 | 上脸实拍 | 看成分表 | missing-evidence |
