...
- Content Studio 真实客户端已补原型第一批落地差距：内容知识地图支持矩阵行下钻查看证据摘录、素材状态、恢复路径和交付去向；行详情可进入审核任务、Prompt 工作台、场景库、SOP 输入和品牌战情室；详情页可切换 IP 口径、竞品观察、团队知识包、素材回写和高级导出；高级导出可生成本机预览。
